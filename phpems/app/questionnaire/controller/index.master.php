...
class action extends app
{
    ...
    private function selectmember()
    {
        ...
        $questionnaireid = intval($this->ev->get('$questionnaireid'));
        $course = $this->questionnaire->getQuestionnaireById($questionnaireid);
    ...
    private function index()
    {
        ...
        $courses = $this->questionnaire->getCourseList($args,$page,10);
        $this->tpl->assign('page',$page);
        $this->tpl->assign('catid',$catid);
