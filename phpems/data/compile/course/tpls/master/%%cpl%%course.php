...
<?php } ?>
 ...
 $cid++; ?>
					            	<tr>
					                    ...
					                    <td>
					                        <a href="index.php?questionnaire-master-index"><?php echo $course['cstitle']; ?></a>
					                    </td>
					                    <td>
					                    ...
					                    <td class="actions">
					                    	<div class="btn-group">
												<a class="btn" href="index.php?course-master-course-toExclel" title="导出EXECL"><em class="glyphicon-cloud"></em></a>
